...
class GraduationRegistrationScreen extends ConsumerWidget {
        ...
        error: (error, stack) => Center(
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 16),
              OutlinedButton.icon(
                onPressed: () => ref.invalidate(graduation_registrationProvider),
  ...
  Widget _buildContent(BuildContext context, GraduationRegistrationResponse data, ThemeData theme) {
    return ListView(
